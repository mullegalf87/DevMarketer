...
$titolo = "Eliminazione provincia";
$message = "Sei sicuro di voler rimuovere ?";
$id = filter_input(INPUT_GET, 'id');
if (isset($_POST['Delete'])) {
    $result = gaz_dbi_del_row($gTables['provinces'], "id", filter_input(INPUT_POST, 'id'));
    header("Location: report_provinces.php");
    exit;
} else {
    $form = gaz_dbi_get_row($gTables['provinces'], "id", $id);
}
...
<form method="POST" action="<?php print $_SERVER['PHP_SELF'] . "?id=" . $id; ?>" >
    ...
    <div align="center" font class="FacetFormHeaderFont">Attenzione!!! Eliminazione provincia ID: <?php print $id; ?> </div>
    <table class="GazFormDeleteTable">
        ...
        <tr>
            <td class="FacetFieldCaptionTD">ID provincia</td>
        ...
        <tr>
            <td class="FacetFieldCaptionTD">Sigla  </td>
            <td class="FacetDataTD"><?php print $form["abbreviation"] ?> </td>
        </tr>
