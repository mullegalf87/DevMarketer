...
CREATE TABLE gaz_XXXagenti_forn (`id_agente` int(9) NOT NULL,`id_fornitore` int(9) NOT NULL,`base_percent` decimal(4,2) NOT NULL,`tipo_contratto` tinyint(1) NOT NULL,`adminid` varchar(20) NOT NULL,`last_modified` timestamp NOT NULL DEFAULT NOW() ON UPDATE CURRENT_TIMESTAMP) ENGINE=MyISAM DEFAULT CHARSET=utf8;
