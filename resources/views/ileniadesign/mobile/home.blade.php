            ...
            <div class="collapse navbar-collapse" id="myNavbarToggler7" style="justify-content: center;">
                <ul class="navbar-nav w-100">
                    ...
                    <div class="d-none d-lg-block w-100 text-center" style="padding-top: 8px;">
                        ...
                        white-space: nowrap;">ILENIA ZITO - mobile</h4>
                    </div>
                    <li class="nav-item text-center pr-3 pl-3">
                    ...
                    <div class="col-md-4 h-100 p-0">
                        <div class="w-100">
                            <div class="circle append_span_circle">
                                <span class="text">HANDCRAFTED - mobile</span>
                            </div>
                        </div>
                        <img style="position: absolute; bottom:0;right: 0; left: 0;margin-bottom: 3rem!important;" class="img-corner m-auto" src="ileniadesign_repo/1.jpeg">
                    </div>
                ...
                <div class="d-flex flex-nowrap">
                    <div class="col-md-6" style="z-index: 1;">
                        <div style="top: 0; position: absolute; right: 0;padding-top: 15%; bottom: 0;">
                            <div style="margin-left: 25%;">
                                <img class="" style="border-radius: 0;width: 40%;float:right;margin-right: 25px;" src="ileniadesign_repo/1.jpeg">
                    ...
                    <div class="col-md-6" style="z-index: 0;">
                        <div>
                            ...
                            <img class="img-corner" style="top: 0; border-radius: 0; position: absolute; left: 0;padding-top: 15%; bottom: 0; width: 45%;" src="ileniadesign_repo/2.jpeg">
                        </div>
                    </div>
                </div>
            </section>
