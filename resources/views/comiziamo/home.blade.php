...
<head>
  ...
  <meta property="og:image" content="http://www.comiziamo.tk/comiziamo_repo/logo/logo_small_icon_only.png">
 <!-- tag twitter -->
  <!-- <meta name="twitter:card" content="summary"> -->
  <!-- <meta name="twitter:image" content="https://i.ibb.co/hZnWTGB/logo-small-icon-only.png"> -->
  <!-- <meta name="twitter:image" content="http://www.comiziamo.tk/comiziamo_repo/logo/logo_small_icon_only_twitter.jpeg">
 -->



  <!-- favicon -->
  <link rel="icon" href="comiziamo_repo/logo/favicon_small.png" type="image/png">
  <!-- jquery 3.5 jquery-->
  ...
  function get_arguments(){
    ...
    for (var i = 0; i < 8; i++) {
      ...
      if (res[i].img_arg=="") {
        ...
        image_arg='url(comiziamo_repo/default_img.png?refresh=<?php echo rand(1,999); ?>)';

      }else{

        image_arg='url(comiziamo_repo/img_argument/'+res[i].img_arg+')';
